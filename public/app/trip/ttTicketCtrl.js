angular.module('app').controller('ttTicketCtrl', ['$scope', 'ttTripService', 'ttNotifier', 'ttIdentity', function($scope, ttTripService, ttNotifier, ttIdentity) {
  ...
  $scope.purchase = function() {
    console.log(ttIdentity.currentUser);
